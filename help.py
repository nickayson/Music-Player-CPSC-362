...
class Help:
    def openHelpWindow(self):
        ...
        self.muteInfo = tk.Label(self.HelpWindow, bg = 'blue', fg = 'white', font=("Gotham Medium typeface",font_size - 9,"bold"), text=text_) 
        ...
        text_length = len(text_)
        font_size = int((w_h_ratio / text_length) / x)
        self.LibraryInfo = tk.Label(self.HelpWindow, bg = 'purple', fg = 'white', font=("Gotham Medium typeface",font_size - 1,"bold"), text=text_)
		# Anchor just below above Label
        self.LibraryInfo.pack(anchor='ne', pady= 1)
