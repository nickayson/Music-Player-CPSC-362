...
class Help:
    def openHelpWindow(self):
        ...
        text_length = len(text_)
        font_size = int((w_h_ratio / text_length) / x)
        self.LibraryInfo = tk.Label(self.HelpWindow, bg = 'purple', fg = 'white', font=("Gotham Medium typeface",font_size + 0,"bold"), text=text_)
        ...
        text_length = len(text_)
        font_size = int((w_h_ratio / text_length) / x)
        self.about_loadsong = tk.Label(self.HelpWindow, bg = '#4AC1E1', fg = 'white', font=("Gotham Medium typeface",font_size + 1,"bold"), text= text_)	
        ...
        text_length = len(text_)
        font_size = int((w_h_ratio / text_length) / x)
        self.queueInfo = tk.Label(self.HelpWindow, bg= 'green', fg = 'white', font=("Gotham Medium typeface",font_size - 4,"bold"), text= text_)
